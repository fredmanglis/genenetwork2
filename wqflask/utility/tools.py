...
ELASTICSEARCH_HOSTS = get_setting('ELASTICSEARCH_HOSTS')
...
PYTHON2_PROFILE    = get_setting("PYTHON2_PROFILE")
PYTHON2_PATH       = PYTHON2_PROFILE+"/lib/python2.7/site-packages"
