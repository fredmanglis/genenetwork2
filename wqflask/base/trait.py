...
def retrieve_trait_info(trait, dataset, get_qtl_info=False):
    ...
    if trait_info:
        ...
        if dataset.type == 'ProbeSet' and dataset.group:
            description_string = str(trait.description).strip(codecs.BOM_UTF8.decode("utf-8")).encode("utf-8")
            target_string = str(trait.probe_target_description).strip(codecs.BOM_UTF8.decode("utf-8")).encode("utf-8")
            ...
            if (len(description_display) > 1 and description_display != 'N/A' and
                ...
                description_display = str(description_display) + '; ' + str(target_string.strip())
